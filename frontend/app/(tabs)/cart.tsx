...
const useStyles = makeStyles((colors) => ({
  ...
  item: { flexDirection: "row", gap: 14, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: colors.divider },
  img: { width: 92, height: 92, borderRadius: 18, backgroundColor: colors.surfaceTertiary },
  itemHead: { flexDirection: "row", justifyContent: "space-between", gap: 8 },
  itemName: { fontFamily: FONT_DISPLAY, fontSize: 19, color: colors.onSurface, flex: 1 },
  itemPrice: { fontFamily: FONT_TEXT, fontSize: 16, fontWeight: "800", color: colors.onSurface },
  ...
  summary: { marginTop: 24, backgroundColor: colors.surfaceInverse, borderRadius: 24, padding: 20, gap: 10 },
  row: { flexDirection: "row", justifyContent: "space-between" },
  rowLabel: { fontFamily: FONT_TEXT, fontSize: 14, color: colors.onSurfaceInverse, opacity: 0.8 },
  rowValue: { fontFamily: FONT_TEXT, fontSize: 14, color: colors.onSurfaceInverse, fontWeight: "600" },
  divider: { height: 1, backgroundColor: colors.onSurfaceInverse, opacity: 0.15, marginVertical: 4 },
