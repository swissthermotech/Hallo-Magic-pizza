...
const useStyles = makeStyles((colors) => ({
  ...
  hero: { height: 340, backgroundColor: colors.surfaceTertiary },
  heroImg: { width: "100%", height: "100%" },
  heroScrim: { position: "absolute", left: 0, right: 0, top: 0, bottom: 0 },
  closeBtn: { position: "absolute", left: 16, width: 40, height: 40, borderRadius: 20, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center" },
  heroText: { position: "absolute", left: 20, right: 20, bottom: 20 },
  name: { fontFamily: FONT_DISPLAY, fontSize: 34, color: colors.onSurfaceInverse, lineHeight: 40 },
  basePrice: { fontFamily: FONT_TEXT, fontSize: 18, fontWeight: "700", color: colors.onSurfaceInverse, marginTop: 4, opacity: 0.9 },
  ...
  sizeCard: { flex: 1, height: 68, borderRadius: 14, borderWidth: 1.5, borderColor: colors.border, backgroundColor: colors.surfaceSecondary, alignItems: "center", justifyContent: "center", gap: 2 },
  sizeCardOn: { borderColor: colors.brandPrimary, backgroundColor: colors.brandSoft },
  sizeLabel: { fontFamily: FONT_TEXT, fontSize: 16, fontWeight: "800", color: colors.onSurface },
  sizeLabelOn: { color: colors.brandPrimary },
  sizePrice: { fontFamily: FONT_TEXT, fontSize: 13, color: colors.muted },
